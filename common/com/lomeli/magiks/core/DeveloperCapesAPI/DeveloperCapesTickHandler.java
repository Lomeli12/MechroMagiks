 ...
 * version 1.3.1
 */
package com.lomeli.magiks.core.DeveloperCapesAPI;
...
public class DeveloperCapesTickHandler implements ITickHandler
{
    ...
    private static final DeveloperCapesAPI instance = DeveloperCapesAPI
            .getInstance();
                ...
                if (players.get(counter) != null)
                {
                            ...
                            .startsWith("http://skins.minecraft.net/MinecraftCloaks/"))
                    {
                        ...
                        if (instance.getUser(lowerUsername) != null)
                        {
                            ...
                            // url.
                            DeveloperCapesUser hashUser = instance
                                    .getUser(lowerUsername);
                            String groupUrl = instance.getGroupUrl(hashUser
                                    .getGroup());
                            ...
                            if (player.cloakUrl != oldCloak
                                    & player.cloakUrl != oldCloak)
                            {
                                // download the cloak. the second arguement is
