...
{
    public static int flyingRingID;
    ...
    public static int smeltingUpgradeID;
    ...
    public static int kineticGenID;
    ...
    public static int manceryStoneStairsID;
    ...
    public static int stamaticBlockID;
