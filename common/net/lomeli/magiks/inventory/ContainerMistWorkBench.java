...
public class ContainerMistWorkBench extends Container
{
	...
	public ContainerMistWorkBench(InventoryPlayer inventoryPlayer, World world, int x, int y, int z)
	{
		this.worldObj = world;
        this.posX = x;
        this.posY = y;
        ...
        for (var6 = 0; var6 < 3; ++var6)
        {
        	...
        	{
        		this.addSlotToContainer(new Slot(inventoryPlayer, var7 + var6 * 9 + 9, 8 + var7 * 18, 84 + var6 * 18));
        	}
        }

        for (var6 = 0; var6 < 9; ++var6)
        {
        	this.addSlotToContainer(new Slot(inventoryPlayer, var6, 8 + var6 * 18, 142));
        }
