...
public class BluePrintRecipeSorter implements Comparator
{
    final BluePrintRecipeManager recipeSorter;

    BluePrintRecipeSorter(BluePrintRecipeManager craftingManager)
    {
